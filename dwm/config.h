...
static const char *fonts[]          = { "JetBrains Mono:size=8", "FontAwesome:size=9" };
static const char dmenufont[]       = "Product Sans:size=8";
static const char col_gray1[]       = "#222222";
static const char col_gray2[]       = "#444444";
static const char col_gray3[]       = "#bbbbbb";
static const char col_gray4[]       = "#eeeeee";
static const char col_cyan[]        = "#3971ED";
static const char col_green[]       = "#339933";
...
static Key keys[] = {
    ...
    /* dmenu scripts */
	{ MODKEY|ShiftMask,	        XK_z,      spawn,           SHCMD("~/.bin/tabbed -c zathura -e") },
